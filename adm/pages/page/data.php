              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                    ...
                    $page =new Page();
                    $rows_page = $page->selectall();

                    foreach ($rows_page as $row)
                    {
                  ?>
                <tr>
                  <td width="20%"><img src="../img/pages/<?php echo $row['file']?>" width="30%" alt="<?php echo $row['judul']; ?>"></td>
                  ...
                  <td>
                    ...
                    <a href="hapus5-<?php echo $row['id']?>" onclick="return confirm('Are you sure ?')" class="btn btn-sm btn-warning btn-flat"><i class="fa fa-trash"></i></a>
                  </td>
                ...
                <div class="modal fade" id="myModal<?php echo $row['id']; ?>" role="dialog">
                  ...
                  ?>
                      ...
                      <div class="container-fluid">
                                  ...
                                  <div class="form-group">
                                    <label>Content Singkat</label>

                                    <div class="input-group">
                                      
                                      <textarea name="konten_singkat" rows="5" class="ckeditor"><?php echo $result['konten_singkat']; ?></textarea>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <textarea name="konten" rows="5" class="ckeditor"><?php echo $result['konten']; ?></textarea>
                                ...
                                <div class="container-fluid">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="input-group">
                                      ...
                                      <textarea name="konten_singkat" rows="5" class="ckeditor" ></textarea>
